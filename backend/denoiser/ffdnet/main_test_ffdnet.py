...
def main():
    ...
    noise_level_img = 5                 # noise level for noisy image
    noise_level_model = noise_level_img  # noise level for model
    model_name = 'ffdnet_color'           # 'ffdnet_gray' | 'ffdnet_color' | 'ffdnet_color_clip' | 'ffdnet_gray_clip'
    testset_name = 'test_input'               # test set,  'bsd68' | 'cbsd68' | 'set12' (this should be the name of folder in testsets)
    # 'Done  bicycle, Boat, Bottle, Bus, Car, Cat, Chair, Cup, Dog, Motorbike, People, Table'
